...
```bash
cortex automation resume COCO_ROUTINE_AGENT_RAM_SLACK_MONITOR --connection snowhouse 2>&1
cortex automation resume COCO_ROUTINE_AGENT_RAM_SLACK_B --connection snowhouse 2>&1
cortex automation resume COCO_ROUTINE_AGENT_RAM_SLACK_C --connection snowhouse 2>&1
cortex automation resume COCO_ROUTINE_AGENT_RAM_SLACK_D --connection snowhouse 2>&1
```
